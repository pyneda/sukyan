...
func StartAPI(opts ...APIServerOptions) {
	...
	if err := db.Connection().MarkOrphanedWsFuzzRunsAborted(); err != nil {
...
func buildAPIApp(deps apiDeps) *fiber.App {
	...
	api.Post("/workspaces/:workspace_id/matcher-presets", JWTProtected(), CreateMatcherPreset)
	api.Put("/workspaces/:workspace_id/matcher-presets/:id", JWTProtected(), UpdateMatcherPreset)
	api.Delete("/workspaces/:workspace_id/matcher-presets/:id", JWTProtected(), DeleteMatcherPreset)
	...
	api.Post("/playground/fuzz/preview", JWTProtected(), FuzzPreview)
	...
	api.Post("/playground/fuzz/runs/:run_id/pause", JWTProtected(), PauseFuzzRun)
	api.Post("/playground/fuzz/runs/:run_id/resume", JWTProtected(), ResumeFuzzRun)
	...
	api.Put("/playground/fuzz/runs/:run_id/matchers", JWTProtected(), PutFuzzRunMatchers)
	api.Post("/playground/fuzz/runs/:run_id/match", JWTProtected(), MatchFuzzRun)
	...
	api.Get("/users", JWTProtected(), SuperuserProtected(), ListUsersHandler)
