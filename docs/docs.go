...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/api.CreateAPIDefinitionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/api-definitions/{id}/endpoints/{endpoint_id}/detail": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Return credentials unmasked",
                        "name": "reveal",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.endpointDetailResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/auth/token/renew": {
            "post": {
                "description": "Renew access and refresh tokens. The refresh token is read from the\nHttpOnly cookie set at sign-in, falling back to the request body for\nnon-browser clients. No access token is required, so a session resumes\neven after the access token has expired.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Refresh token, when not supplied as a cookie",
                        "name": "refresh_token",
                        "in": "body",
                        "schema": {
        ...
        "/api/v1/auth/user/sign/in": {
            "post": {
                "description": "Auth user and return access and refresh token. The refresh token\nis also set as an HttpOnly cookie scoped to /api/v1/auth; browser\nclients should rely on that cookie rather than storing the token.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/v1/auth/user/sign/out": {
            "post": {
                "description": "Clears the refresh token cookie, ending the session. Deliberately\nunauthenticated: clearing a cookie needs no identity, and requiring\na live access token would leave an expired session unable to sign out.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/v1/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Only requests at or below this URL (matched against clean_url)",
                        "name": "url_prefix",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/history/websocket/connections": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Case-insensitive substring match against the connection URL",
                        "name": "query",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Only return connections with at least this many messages",
                        "name": "min_messages",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/scans/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update scan input",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.UpdateScanInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/scans/{id}/jobs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort field: relevance (default), id, created_at, updated_at, status, priority",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/stats/deployment/findings": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "RFC3339 timestamp bounding the totals. Does not filter the listed rows.",
                        "name": "since",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Maximum rows to list, 1-50 (default 12).",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully retrieved deployment findings",
                        "schema": {
                            "$ref": "#/definitions/db.DeploymentFindings"
                        }
                    },
                    "400": {
        ...
        "/api/v1/stats/deployment/pulse": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved deployment pulse",
                        "schema": {
                            "$ref": "#/definitions/db.DeploymentPulse"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
        ...
        "/api/v1/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "email, last_login, created_at, status or superuser",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Requires a superuser account",
                        "schema": {
                            "$ref": "#/definitions/api.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/workspaces/import": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Code for the imported workspace",
                        "name": "code",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Title for the imported workspace",
                        "name": "title",
                        "in": "query"
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/workspace.ImportResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/workspaces/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    "202": {
                        "description": "message\": \"Workspace deletion started",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "api.CreateAPIDefinitionResponse": {
            "type": "object",
            "properties": {
                "auth_config": {
                    "$ref": "#/definitions/db.APIAuthConfig"
        ...
        "api.ReportRequest": {
            ...
            "properties": {
                "disable_syntax_highlight": {
                    "description": "Omitting this highlights, matching the UI. See report.ReportOptions.",
                    "type": "boolean"
                },
                "format": {
                    "enum": [
        ...
        "api.UsersResponse": {
            ...
            "properties": {
                ...
                "summary": {
                    "$ref": "#/definitions/db.UserRosterSummary"
                }
            }
        },
        "api.WSDLSchemaInfo": {
        ...
        "api.endpointDetailResponse": {
            ...
            "properties": {
                ...
                "operation": {
                    "$ref": "#/definitions/core.Operation"
                }
            }
        },
        ...
        "core.OpenAPIMetadata": {
            ...
            "properties": {
                ...
                "request_body": {
                    "$ref": "#/definitions/core.RequestBodyInfo"
                },
                "servers": {
                    "type": "array",
                    "items": {
        ...
        "core.Operation": {
            ...
            "properties": {
                "api_type": {
                    "$ref": "#/definitions/core.APIType"
                },
                "base_url": {
                    "type": "string"
                },
                "content_types": {
                    "$ref": "#/definitions/core.RequestContentTypes"
                },
                "definition_id": {
                    "type": "string"
                },
                ...
                "graphql": {
                    "$ref": "#/definitions/core.GraphQLMetadata"
                },
                "id": {
                    "type": "string"
                },
                ...
                "openapi": {
                    "$ref": "#/definitions/core.OpenAPIMetadata"
                },
                "operation_id": {
                    "type": "string"
                },
                "parameters": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.Parameter"
                    }
                },
                "path": {
                    "type": "string"
                ...
                "responses": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.ResponseInfo"
                    }
                },
                "security": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.SecurityRequirement"
                    }
                },
                "soap": {
                    "$ref": "#/definitions/core.SOAPMetadata"
                },
                "summary": {
                    "type": "string"
                },
        ...
        "core.Parameter": {
            ...
            "properties": {
                ...
                "constraints": {
                    "$ref": "#/definitions/core.Constraints"
                },
                "content_type": {
                    "type": "string"
                },
                "data_type": {
                    "$ref": "#/definitions/core.DataType"
                },
                "default_value": {},
                "deprecated": {
                    "type": "boolean"
                ...
                "location": {
                    "$ref": "#/definitions/core.ParameterLocation"
                },
                "name": {
                    "type": "string"
                },
        ...
        "core.ParameterLocation": {
            ...
            "x-enum-comments": {
                "ParameterLocationArgument": "GraphQL"
            },
            "x-enum-descriptions": [
                "",
                "",
            ...
            "x-enum-varnames": [
                ...
                "ParameterLocationArgument"
            ]
        },
        "core.RequestBodyInfo": {
            "type": "object",
            "properties": {
                "content_type": {
                    "type": "string"
        ...
        "db.DeploymentFindings": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/db.DeploymentFinding"
                    }
                },
                "issues": {
                    "$ref": "#/definitions/db.IssuesStats"
        ...
        "db.DeploymentPulse": {
            ...
            "properties": {
                ...
                "buckets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/db.DeploymentPulseBucket"
                    }
                },
                "end": {
                    "type": "string"
        ...
        "db.HistoryFilter": {
            ...
            "properties": {
                ...
                "url_prefix": {
                    "description": "Matched against clean_url, which is indexed, so this is a btree prefix scan.",
                    "type": "string"
                },
                "url_prefixes": {
                    "description": "A selection of sitemap nodes. Folded together with URLPrefix; same semantics.",
                    "type": "array",
                    "maxItems": 200,
                    "items": {
                        "type": "string"
        ...
        "db.OOBTest": {
            ...
            "properties": {
                ...
                "interactions_count": {
                    "description": "Callbacks received against this test. Derived rather than stored, so it is\nfilled in by the read paths; a zero value means none came back.",
                    "type": "integer"
                },
                "issue_id": {
                    "type": "integer"
        ...
        "db.SitemapNode": {
            ...
            "properties": {
                ...
                "example_id": {
                    "description": "Only meaningful on endpoints — a directory's is an arbitrary descendant.",
                    "type": "integer"
                },
                "has_children": {
                    "type": "boolean"
                ...
                "params": {
                    "description": "Derived from the URL on read; parameter names are not persisted anywhere.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "websocket": {
                    "description": "WebSocket describes this exact node; the two counts below are\nsubtree-inclusive like Requests.",
                    "type": "boolean"
                }
            }
        },
        ...
        "options.FullScanCrawlOptions": {
            ...
            "properties": {
                ...
                "max_pages_with_same_parameters": {
                    "type": "integer",
                    "minimum": 0
                },
                ...
                "page_setup_timeout_seconds": {
                    "type": "integer",
                    "maximum": 300,
                    "minimum": 1
                },
                "page_stable_duration_seconds": {
                    "type": "integer",
                    "maximum": 60,
                    "minimum": 1
                },
                "page_stable_timeout_seconds": {
                    "type": "integer",
                    "maximum": 120,
                    "minimum": 1
                },
        ...
        "options.FullScanOptions": {
            ...
            "properties": {
                ...
                "crawl_options": {
                    "$ref": "#/definitions/options.FullScanCrawlOptions"
                },
                "exclude_patterns": {
                    "type": "array",
                    "items": {
        ...
        "workspace.ImportResult": {
            ...
            "properties": {
                ...
                "skipped_tables": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/workspace.ExcludedTable"
                    }
                },
                "source": {
                    "$ref": "#/definitions/workspace.WorkspaceInfo"
                },
                "total_rows": {
                    "type": "integer"
                },
