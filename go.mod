...
require (
	github.com/BishopFox/jsluice v0.0.0-20230919151349-0dc9d20d1909
...
require (
	...
	github.com/projectdiscovery/goflags v0.1.22 // indirect
	...
	github.com/projectdiscovery/retryablehttp-go v1.0.29 // indirect
