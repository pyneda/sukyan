...
func (a *ClientSidePrototypePollutionAudit) evaluateWithContext(parentCtx context.Context, quote string) {
	...
	hijackRouter := browser.HijackWithContext(browser.HijackConfig{}, b, nil, "Scanner", hijackResultsChannel, hijackContext, a.WorkspaceID, a.TaskID, a.ScanID, a.ScanJobID)
