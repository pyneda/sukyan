...
<body>
    ...
    <main>
        ...
        <label>Headers:</label>
        <textarea id="requestHeaders" rows="5" cols="50"></textarea><br><br>

        <label>Body:</label>
        <textarea id="requestBody" rows="10" cols="50"></textarea><br><br>

        <button id="forwardButton">Forward Modified</button>
    ...
    <script>
        ...
        ws.onmessage = function(event) {
            ...
            document.getElementById('requestHeaders').textContent = JSON.stringify(data.header, null, 2); 
